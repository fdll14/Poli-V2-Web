...
class Train:
    def train(self):
        ...
        documents = []
        ignore_words = ["?", "!"]
        data_file = open(r"D:\Poli\app\resources\intents.json").read()
        ...
        pickle.dump(words, open(r"D:\Poli\app\resources\words.pkl", "wb"))
        pickle.dump(classes, open(r"D:\Poli\app\resources\classes.pkl", "wb"))
        ...
        model.save(r"D:\Poli\app\resources\chatbot_model.h5", hist)
        print("model created")
